...
Reads the actual Email and Work Email columns from your CSV
"""
import boto3
import csv
    ...
    with open(CSV_FILE, 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            employee_data = {
                ...
                # Default values (use Decimal for DynamoDB)
                'points': Decimal('0.0'),
            ...
            if email or work_email:
                with_emails += 1
                print(f"✓ {employee_data['name']:30} Email: {email:40} Work: {work_email}")
            else:
                without_emails += 1
                print(f"○ {employee_data['name']:30} NO EMAILS")
...
if __name__ == '__main__':
    ...
    print(f"Target DynamoDB table: panda-employees")
    print(f"{'='*80}\n")
